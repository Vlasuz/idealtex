...
{/* <div className="product-card">
                      <div className="product-card__top">
                          ...
                          <a href="" className="product-card__image-ibg">
                              <picture><source srcSet="img/main-img/product.webp" type="image/webp" /><img src="img/main-img/product.png" alt="" /></picture>
                          </a>
                          <div className="product-card__options options">
                              ...
                              <div className="options__item">
                                  ...
                                  <label htmlFor="o_2" className="options__label"><span className="options__info">уп <br />
                                          100 шт</span><span className="options__price">
                                          0,02 грн
                                      </span></label>
                              </div>
                              <div className="options__item">
                                  <input checked hidden id="o_22" className="options__input" type="radio" value="2" name="option" />
                                  <label htmlFor="o_22" className="options__label"><span className="options__info">уп <br />
                                          50 шт</span><span className="options__price">
                                          0,02 грн
                                      </span></label>
                              </div>
                              <div className="options__item">
                                  <input hidden id="o_222" className="options__input" type="radio" value="2" name="option" />
                                  <label htmlFor="o_222" className="options__label"><span className="options__info">уп <br />
                                          10 шт</span><span className="options__price">
                                          0,02 грн
                                      </span></label>
                              </div>
                          </div>
                          ...
                          <div className="product-card__row">
                              <div data-quantity className="quantity">
                                  <button data-quantity-minus type="button" className="quantity__button quantity__button_minus">
                                      <img src="img/icons/minus.svg" alt="" /></button>
                                  <div className="quantity__input">
                                      <input data-quantity-value autoComplete="off" type="text" name="form[]" value="2" />
                                  </div>
                                  <button data-quantity-plus type="button" className="quantity__button quantity__button_plus">
